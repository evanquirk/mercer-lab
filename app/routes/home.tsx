  ...
  return (
    <>
      <Hero
        ...
        description="Prion diseases are a group of rare and invariably fatal protein misfolding neurodegenerative diseases that include Creutzfeldt-Jakob disease (CJD) of humans, bovine spongiform encephalopathy (BSE or “mad cow disease”) of cattle, and chronic wasting disease (CWD) of deer, elk, and moose. Although they affect different species, these diseases share a key molecular event: the conversion of the normally soluble prion protein (PrP<sup>C</sup>) into a misfolded, disease-causing conformation (PrP<sup>Sc</sup>) that is rich in β-sheet structure, insoluble, and resistant to proteolytic degradation. Our laboratory is interested in the molecular and cellular underpinnings of this spread, and how similar “prion-like” mechanisms are at play in more common diseases like Alzheimer’s, Parkinson’s, and frontotemporal dementia. Our work has been supported by the National Institutes of Health, the United States Department of Defense, the United States Department of Agriculture, the Arizona Alzheimer's Consortium, and the Creutzfeldt-Jakob Disease Foundation."
      />
